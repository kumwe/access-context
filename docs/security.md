...
Security Advisory reporting when available; otherwise contact the maintainer privately before sharing exploit details.
...
Do not accept PHP unserialization or an exported JSON record as an authenticated context. Use `toArray()` for redacted
